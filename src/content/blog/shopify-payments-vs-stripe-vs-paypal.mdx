---
title: "Shopify Payments vs Stripe vs PayPal 2026: Which Saves More"
excerpt: "Shopify Payments vs Stripe vs PayPal compared: real transaction fees, international support, and which setup saves most by store size and AOV."
date: "2026-03-12"
category: "Guide"
...
updated: "2026-07-24"
faqs:
  - question: "Should I use PayPal or Shopify Payments?"
    answer: "Use both, in a specific arrangement: Shopify Payments as your primary processor and PayPal as a secondary checkout option. Shopify Payments has lower card rates (2.5-2.9 percent plus 30 cents depending on plan, versus PayPal's 3.49 percent plus 49 cents), eliminates Shopify's third-party transaction fee, and unlocks Shop Pay accelerated checkout. PayPal as a secondary option then captures the 25-30 percent of shoppers who prefer paying with PayPal, with no extra Shopify fees on those transactions either. The only scenario where PayPal alone makes sense is when Shopify Payments is unavailable for your country or product category."
  - question: "Does Shopify charge extra fees if I do not use Shopify Payments?"
    answer: "Yes, Shopify charges additional transaction fees on top of your payment processor's fees if you use a third-party payment gateway instead of Shopify Payments. The additional fees are 2 percent on Basic Shopify, 1 percent on Grow, 0.6 percent on Advanced Shopify, and 0.15 percent on Shopify Plus. These fees apply to every transaction and can add up significantly. For a store processing $50,000 per month on Basic Shopify, that is an extra $1,000 per month in fees. This is why most merchants use Shopify Payments as their primary processor and add PayPal as a secondary option."
  ...
  - question: "Which payment processor has the lowest fees for Shopify stores?"
    answer: "Shopify Payments on the Advanced Shopify plan offers the lowest effective cost for most merchants. The card processing rate is 2.5 percent plus $0.30 per online transaction with no additional Shopify transaction fees. If you use Stripe as a standalone gateway, you pay 2.9 percent plus $0.30 plus Shopify's 0.6-2 percent additional fee. PayPal charges 3.49 percent plus $0.49 for standard transactions. For a store processing $100,000 per month, Shopify Payments on Advanced saves approximately $500-2,000 per month compared to Stripe or PayPal as the primary processor. The exact savings depend on your Shopify plan and transaction volume."
...
- Eliminates Shopify's additional transaction fees (0.6-2 percent)
...
## Shopify Payments vs PayPal: The Direct Answer

This is the head-to-head most merchants actually search for, so here it is plainly: **Shopify Payments should be your primary processor, and PayPal should be offered alongside it — not instead of it.** They are not competing for the same job. Shopify Payments processes the card payments that make up the majority of your orders at the lowest available rates; PayPal is a wallet option that captures shoppers who won't check out any other way.

| | Shopify Payments | PayPal |
|---|---|---|
| **Online rate** | 2.5–2.9% + 30¢ (by plan) | 3.49% + 49¢ standard |
| **Extra Shopify transaction fee** | None | None (as secondary option) |
| **Shop Pay accelerated checkout** | Yes — exclusive | No |
| **Buyer-recognition trust** | Growing (Shop Pay network) | 430M+ active accounts |
| **Currency conversion** | ~1.5% | 3–4% |
| **Payouts** | 2–3 business days | Instant to PayPal balance; 1–3 days to bank |
| **Best role** | Primary processor | Secondary checkout button |

The math favors this combination at every store size. On a $100 order, Shopify Payments on Basic costs $3.20 in processing; the same order through PayPal costs $3.98. But removing PayPal entirely costs more than the fee difference — a meaningful share of shoppers simply prefer it, especially for purchases over $100 where buyer protection matters to them. Offer both, let customers choose, and the blended rate lands lower than either alone would convert.
...
- Shopify Grow ($105/month): 2.7% + $0.30 per transaction
- Advanced Shopify ($399/month): 2.5% + $0.30 per transaction
- Shopify Plus ($2,300+/month): Negotiated rates, typically 2.15-2.25% + $0.30

**Stripe standalone rates**:
- Standard rate: 2.9% + $0.30 per transaction
- Plus Shopify's additional fees: 2% (Basic), 1% (Grow), 0.6% (Advanced), 0.15% (Plus)
...
- Shopify Payments (Grow plan): $1,550 processing + $0 additional = $1,550 total
- Stripe standalone (Grow plan): $1,650 processing + $500 additional = $2,150 total
- Shopify Payments + PayPal (70/30 split): $1,085 + $622 + $0 additional = $1,707 total

**$200,000 monthly revenue (2,667 transactions)**:
- Shopify Payments (Advanced plan): $5,800 processing + $0 additional = $5,800 total
- Stripe standalone (Advanced plan): $6,100 processing + $1,000 additional = $7,100 total
- Shopify Payments + PayPal (70/30 split): $4,060 + $2,488 + $0 additional = $6,548 total
...
The additional 0.6-2 percent fee Shopify charges for third-party processors is easy to overlook but adds up significantly. For a store doing $100,000/month on Basic Shopify with a third-party processor, that is $2,000/month in fees that Shopify Payments would eliminate.
...
- [What Is Shop Pay? Guide for Merchants and Buyers](/blog/what-is-shop-pay-merchants-buyers)
- [Shopify's Credit Card and Transaction Fees, Explained](/blog/shopify-transaction-credit-card-fees-explained)
- [Shopify Pricing 2026: What Every Plan Actually Costs](/blog/shopify-pricing-2026-every-plan-real-cost)
