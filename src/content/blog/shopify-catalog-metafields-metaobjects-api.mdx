...
Now one edit to the metaobject updates every product that references it — the whole point of modeling shared data as a record instead of copy-pasting metafields ([Shopify: metaobject references](https://shopify.dev/docs/apps/build/metaobjects/data-modeling-with-metafields-and-metaobjects)).
