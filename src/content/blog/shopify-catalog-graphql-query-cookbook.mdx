...
excerpt: "Copy-paste Shopify Admin GraphQL queries & mutations for the product catalog: reads, productSet writes, bulk exports, product feeds, price lists, and."
date: "2026-06-20"
updated: "2026-06-20"
category: "Developers"
...
Every snippet targets the **GraphQL Admin API**, so you'll need a [Shopify store](https://shopify.pxf.io/c/6318547/3797171/13624) with Admin API access to run them. Pin an explicit version in your endpoint (e.g. `/admin/api/2025-07/graphql.json`) and request only the fields you need — GraphQL bills by calculated query cost.
