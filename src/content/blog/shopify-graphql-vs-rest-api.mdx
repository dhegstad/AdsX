...
You do not need a rewrite. Both APIs run side by side against the same [Shopify store](https://shopify.pxf.io/c/6318547/3797171/13624), so migrate one resource at a time and verify parity as you go.
