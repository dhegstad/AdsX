...
See how this intersects with paid attribution in our breakdown of [Shopify attribution models explained](/blog/shopify-attribution-models-explained).
...
**You don't yet have a direct-to-consumer store.** If you're 100% Amazon-native and haven't built a Shopify presence, running your own affiliate program requires building that foundation first. That's a separate, worthwhile project. See our guide on [migrating from Amazon to Shopify](/blog/migrate-from-amazon-to-shopify) for the sequencing.
...
For a deeper look at platform selection, see our [Shopify affiliate program setup guide](/blog/shopify-affiliate-program-setup-guide).
...
If you're running Meta campaigns for a DTC brand, this data flywheel is material. See our [Meta Advantage Plus Shopping Campaign playbook](/blog/meta-advantage-plus-shopping-campaign-playbook) for how to use affiliate cohorts inside ASC targeting.
