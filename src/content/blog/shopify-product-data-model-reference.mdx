...
This is the expanded, field-level reference that the [Shopify Product Catalog API guide](/blog/shopify-product-catalog-api-guide) links to — the pillar has a six-row summary; this page is the full schema with a table per object. To extract these objects at scale, see [fetch your entire catalog with GraphQL](/blog/shopify-fetch-entire-product-catalog-graphql). Everything below uses the **GraphQL Admin API**, where new catalog fields ship first ([Shopify: API versioning](https://shopify.dev/docs/api/usage/versioning)); to query these objects yourself you'll need a [Shopify store](https://shopify.pxf.io/c/6318547/3797171/13624) with Admin API access.
