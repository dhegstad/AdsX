...
Read products and their variants from the **Admin GraphQL API**, which means you'll need a [Shopify store](https://shopify.pxf.io/c/6318547/3797171/13624) with Admin API access. For small catalogs, paginate the `products` connection with a cursor. Pull every attribute Google will need in one pass.
