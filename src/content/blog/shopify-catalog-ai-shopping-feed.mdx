...
Start from a single source of truth: your [Shopify](https://shopify.pxf.io/c/6318547/3797171/13624) catalog, including metafields. For small stores, a paginated Admin GraphQL query is enough. For anything beyond a few hundred products, use the Bulk Operations API so you do not hammer the synchronous API or hit rate limits.
