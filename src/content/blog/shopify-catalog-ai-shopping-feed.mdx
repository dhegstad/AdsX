...
excerpt: "A developer tutorial for building an AI-ready Shopify product feed so AI shopping agents can find, understand, and recommend your products with accurate data."
date: "2026-06-20"
updated: "2026-06-20"
category: "Developers"
...
This is a developer companion to our [Shopify Product Catalog API guide](/blog/shopify-product-catalog-api-guide) and the [query cookbook](/blog/shopify-catalog-graphql-query-cookbook). For the marketing-strategy view, see [preparing your product feed for AI agents](/blog/preparing-your-product-feed-for-ai-agents).
...
- **Materials, dimensions, and specs via metafields.** Store these as typed metafields (for example `specs.material`, `specs.dimensions`, `specs.weight`) so they are queryable and exportable. See our [Shopify metafields guide](/blog/shopify-custom-metafields-guide) for setting up definitions.
...
Keep the JSON-LD values identical to what the page renders — mismatches erode trust and can get listings dropped. For deeper schema patterns, see our [schema markup](/blog/preparing-your-product-feed-for-ai-agents) coverage and the [metafields guide](/blog/shopify-custom-metafields-guide) for sourcing those fields.
