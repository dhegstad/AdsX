...
This builds on the conversion thinking in converting AI shopping traffic and pairs naturally with the native experimentation in [Shopify Rollouts](/blog/shopify-rollouts-native-ab-testing-checkout) — once AI Collection Sort ships, Rollouts is exactly how you'd measure whether it actually beats your manual sort for your traffic.
