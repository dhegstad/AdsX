...
3. [Exclude existing customers](/blog/meta-ads-audience-exclusions-overlap-shopify) using your customer list
...
The minimum viable budget depends on your product's price point and target cost per acquisition (CPA). Setting your [campaign budget too low](/blog/meta-ads-campaign-budget-too-low-symptoms-fix) is one of the most common reasons new campaigns fail to exit the learning phase:
...
Before scaling, calculate your [break-even ROAS](/blog/facebook-ads-break-even-roas-calculator) so you know the minimum return required to stay profitable. Once you identify ad sets consistently hitting your ROAS target for 7+ days:
