...
For broader attribution context on whether your ROAS numbers are measuring the right things, see Shopify Attribution Models Explained and [Blended ROAS vs. Platform ROAS](/blog/blended-roas-vs-platform-roas-reconciliation).
