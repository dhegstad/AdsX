...
MER (Marketing Efficiency Ratio) is total revenue divided by total ad spend. It's blunt — it doesn't tell you which channel is working. But it's blunt in a useful way: it can't lie the way platform-reported ROAS can. For a deeper look at [using MER as your primary scaling metric](/blog/mer-vs-roas-which-metric-to-scale-on) instead of ROAS, that guide walks through the full framework.
...
**Trusting platform-reported ROAS in isolation.** Every platform overstates. The math doesn't work — if Meta says you're at 4x ROAS and Google says 5x ROAS, but [blended MER is 2.5x](/blog/blended-roas-vs-platform-roas-reconciliation), somebody's lying. Probably both.
...
**Ignoring incrementality entirely.** No matter what your attribution stack looks like, periodic incrementality tests are the only way to ground-truth your assumptions — a point covered in depth in [why your ROAS numbers lie](/blog/incrementality-vs-attribution-paid-ads-truth).
