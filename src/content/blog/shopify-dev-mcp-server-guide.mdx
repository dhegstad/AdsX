...
Restart Claude Code, run `/mcp` to confirm it is listed, and the tools are live. New to Claude Code itself? Our [walkthrough of building a Shopify app with Claude Code](/blog/build-shopify-app-with-claude-code) shows the full workflow, MCP setup included.
