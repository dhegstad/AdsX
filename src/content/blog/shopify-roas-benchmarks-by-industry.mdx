...
- **[Blended ROAS](/blog/mer-vs-roas-which-metric-to-scale-on)**: Total store revenue / total ad spend. The most honest metric because it accounts for attribution gaps.
...
[Setting your target ROAS from your profit margin](/blog/target-roas-from-profit-margin-formula) ensures you never bid blind — here is the core formula:
...
1. **Day 1**: [Calculate your true breakeven ROAS](/tools/roas-calculator) and set targets by campaign type
...
- [Target ROAS Formula: Calculate From Profit Margin in 3 Steps](/blog/target-roas-from-profit-margin-formula)
