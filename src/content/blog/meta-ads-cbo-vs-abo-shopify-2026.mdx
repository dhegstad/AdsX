...
This is the threshold we use in client accounts. Below $100/day, CBO can't get enough signal across ad sets fast enough — you end up with one ad set running and the others on $3 in spend at the end of the day. Above $100, the algorithm can actually compare performance. Note that your choice of [daily vs lifetime budget pacing](/blog/daily-vs-lifetime-budget-pacing-paid-ads) also affects how evenly that spend distributes across the day.
...
3. **Are you scaling proven creative across proven audiences?** → CBO, three or more ad sets (then use the [20% budget increase rule vs duplication](/blog/meta-ads-scaling-20-percent-rule-vs-duplication) to decide how to grow spend).
...
**Killing CBO campaigns after 48 hours.** CBO needs 5-7 days of stable spend to find its rhythm. Constant restarts reset the learning phase. If you need tighter cost control without killing the campaign, consider whether a [cost cap or bid cap](/blog/meta-ads-cost-cap-vs-bid-cap-when-to-use) better fits your goal than restarting.
