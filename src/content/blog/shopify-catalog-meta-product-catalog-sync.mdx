...
[Shopify](https://shopify.pxf.io/c/6318547/3797171/13624) is your source of truth. For a small store you can paginate the `products` connection synchronously, but for any real catalog use the **Bulk Operations API** — it runs the query asynchronously and hands you a JSONL file with every product and variant, with no query-cost throttling.
