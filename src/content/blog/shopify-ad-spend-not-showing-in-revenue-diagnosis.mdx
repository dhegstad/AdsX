...
- **Rotate creative aggressively.** If your top creative is more than 6 weeks old and frequency is above 3, launch at least 3 new concepts. See the [Meta ads creative fatigue detection rules](/blog/meta-ads-creative-fatigue-detection-rules) post for specific thresholds.
...
- **Add a new channel.** If Meta is saturated, incremental dollars on Google Shopping or TikTok reach genuinely new buyers. Refer to [paid ads budget allocation by revenue stage](/blog/paid-ads-budget-allocation-by-revenue-stage) for how to split budget when your primary channel saturates.
...
For a more rigorous test, run a geo holdout incrementality test: pause paid spend in 2–3 matched markets for 2 weeks and compare revenue to control markets. [Incrementality testing for Shopify with geo holdouts](/blog/incrementality-testing-shopify-geo-holdout) covers the setup in detail.
...
- Check [shopify attribution models explained](/blog/shopify-attribution-models-explained) for how attribution windows inflate retargeting ROAS
...
If you're running [Shopify](https://shopify.pxf.io/c/6318547/3797171/13624) and spending more than $10K/month on paid, the [MMM vs MTA vs GA4 attribution for ecommerce](/blog/mmm-vs-mta-vs-ga4-attribution-ecommerce) post is the most complete framework for understanding which measurement approach to use at your spend level.
