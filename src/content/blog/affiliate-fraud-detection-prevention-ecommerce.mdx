...
For deeper context on attribution accuracy, the post on [Shopify attribution models explained](/blog/shopify-attribution-models-explained) covers how different models handle multi-touch scenarios where affiliate and paid media overlap. The post on [MMM vs MTA vs GA4 attribution for e-commerce](/blog/mmm-vs-mta-vs-ga4-attribution-ecommerce) is worth reading if you are trying to quantify the halo effect your affiliate program has (or does not have) on other channels.

If you are still building out your affiliate program before fraud controls become an issue, the [Shopify affiliate program setup guide](/blog/shopify-affiliate-program-setup-guide) and the [affiliate vs referral programs comparison](/blog/shopify-affiliate-vs-referral-programs) are the right starting points. Getting the structural controls in place before you scale is far cheaper than auditing a program after fraud has embedded itself.
