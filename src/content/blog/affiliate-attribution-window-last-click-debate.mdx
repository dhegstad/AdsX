...
For [Shopify](https://shopify.pxf.io/c/6318547/3797171/13624) stores building a new affiliate program, the setup decisions you make on day one—especially cookie duration and attribution rule—are much harder to change after affiliates are actively promoting. The Shopify Affiliate Program Setup Guide covers platform selection in depth.
