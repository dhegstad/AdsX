...
This is the write-side counterpart to [fetching your entire catalog with GraphQL](/blog/shopify-fetch-entire-product-catalog-graphql), and it sits under the [Shopify Product Catalog API guide](/blog/shopify-product-catalog-api-guide). If you are still deciding *whether* to adopt it, read [`productSet` vs `productCreate`](/blog/shopify-productset-vs-productcreate) first — this guide assumes you have already chosen `productSet` and want to run it in production. Everything uses the **GraphQL Admin API** at version `2026-01`, so you'll need a [Shopify store](https://shopify.pxf.io/c/6318547/3797171/13624) with Admin API access to run it in production.
