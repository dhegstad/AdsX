...
For more on how to set target ROAS from margin rather than trailing performance, see [Target ROAS From Profit Margin Formula](/blog/target-roas-from-profit-margin-formula) and Shopify ROAS Benchmarks by Industry.
