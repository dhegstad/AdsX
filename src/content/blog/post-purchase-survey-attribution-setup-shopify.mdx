...
faqs:
  ...
  - question: "What tools can I use for post-purchase surveys on Shopify?"
    answer: "The most widely used tools for Shopify post-purchase surveys are KNO Commerce, Fairing (formerly enquire), Zigpoll, and OrderSurvey. KNO Commerce is purpose-built for attribution questions and provides branching logic and benchmarks across thousands of DTC brands. Fairing integrates directly with Shopify's order confirmation page and passes responses to most analytics stacks. Zigpoll is a lower-cost option suitable for stores under $50K/month in revenue. OrderSurvey is a newer app with a free plan that places surveys on both the Thank You and Order Status pages, with conditional branching and NPS tracking on its paid tier. All four sit on the post-purchase page natively within Shopify's checkout."
...
## Choosing a Tool: KNO Commerce, Fairing, Zigpoll, or OrderSurvey

Four tools stand out for Shopify post-purchase surveys. The right choice depends on your revenue volume and the sophistication of your attribution workflow.
...
| [OrderSurvey](https://apps.shopify.com/ordersurvey) | Stores starting out at any size | Free-$49/month | Free plan; surveys on both Thank You and Order Status pages |
...
**[OrderSurvey](https://apps.shopify.com/ordersurvey)**—built by the team behind AdsX—is the newest of the four and the only one with a true free plan, which makes it the fastest zero-cost way to start collecting attribution signal. It renders surveys natively on both the Thank You page and the Order Status page (the latter catches customers who skip the confirmation moment and come back to check their order later), supports conditional branching for follow-up questions, and offers smart targeting by order value, product, tag, country, or currency. The $49/month Pro tier adds NPS tracking, Klaviyo integration, and Shopify POS support for brands that also sell in person.

## Step-by-Step Setup on Shopify

### Step 1: Install Your Survey Tool

Install your chosen tool from the Shopify App Store. All four tools listed above install as standard Shopify apps without requiring custom code. Connect to your [Shopify](https://shopify.pxf.io/c/6318547/3797171/13624) store during onboarding and authorize the necessary checkout permissions.
...
In Shopify's checkout extensibility framework, post-purchase pages support native app embeds. KNO Commerce, Fairing, and OrderSurvey all use Shopify's checkout UI extensions so the survey renders as part of the confirmation page experience, not as an overlay popup. OrderSurvey also surfaces the survey on the Order Status page, which gives customers who navigate away a second natural chance to respond without resorting to a low-converting email survey.
...
KNO Commerce (best for $100K+/month brands with benchmark data), Fairing (best for Triple Whale or Northbeam integrations), Zigpoll (best entry point under $50K/month), and OrderSurvey (free plan, surveys on both the Thank You and Order Status pages). All install natively without custom code.
