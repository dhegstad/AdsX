          ...
          <div className="border border-[#333] bg-[#0a0a0a] flex-grow flex flex-col">
            ...
            <header className="border-b border-[#333] h-[60px] flex justify-between items-center px-6">
              ...
              <div className="flex gap-5">
                ...
                <div
                  className="border border-[#EAEAEA] px-2 py-1 text-[10px] font-bold"
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  v1.0
                </div>
            ...
            <div className="p-6 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 bg-[#050505]">
              <div className="flex gap-6 items-center">
                ...
                <div
                  className="border border-[#EAEAEA] px-2 py-1 text-[9px] flex items-center gap-2"
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  <div className="w-2.5 h-2.5 bg-[#EAEAEA]" />
                  NEXT.JS
                </div>
              ...
              <div className="flex gap-3 items-center">
                <div
                  ...
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  AI SEARCH IS THE NEW FRONTIER. YOUR COMPETITORS ARE ALREADY OPTIMIZING. DON&apos;T GET LEFT BEHIND.
                </div>
