...
export default function HomePage() {
  ...
  return <BrutalistLayout>
    ...
    <section className="grid md:grid-cols-2 border-b border-[#333]">
      <div className="p-8 md:p-12 md:border-r border-b md:border-b-0 border-[#333]"><p className="text-xs text-[#10b981] mb-4">YOUR FIRST STORE</p><h2 className="text-3xl mb-5">Decide before you subscribe.</h2><p className="text-[#aaa] mb-6 leading-relaxed">Work out whether Shopify fits your products, budget, and selling process. Then follow a setup guide built around the essentials.</p><div className="flex flex-wrap items-center gap-5"><Link href="/is-shopify-right-for-you" className="cta-btn">Check the fit →</Link><Link href="/resources/shopify-launch-checklist" className="text-[#10b981] underline">Free launch checklist →</Link></div></div>
      <div className="p-8 md:p-12"><p className="text-xs text-[#10b981] mb-4">FREE TOOLS</p><h2 className="text-3xl mb-5">Put numbers behind the decision.</h2><p className="text-[#aaa] mb-6 leading-relaxed">Estimate your startup budget, check return on ad spend, or review your product feed before committing more money.</p><div className="flex flex-wrap gap-4"><Link href="/tools/shopify-startup-cost-calculator" className="cta-btn">Startup cost calculator →</Link><Link href="/tools/roas-calculator" className="text-[#10b981] self-center underline">ROAS calculator →</Link><Link href="/tools/feed-readiness-checker" className="text-[#10b981] self-center underline">Feed checker →</Link></div></div>
    </section>
